...
public class UserProfileFragment extends ListFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        ArrayList<JSONObject> posts = getPosts(); // create method to get posts
    ...
    private ArrayList<JSONObject> getPosts() {
        String url = "http://10.0.2.2:4599/get_posts_by_id/" + mProfileUserId;
    ...
    private void setProfileDetails() {
        String url = "http://10.0.2.2:4599/get_user_by_id/" + mProfileUserId;
        try {
            String response = new DynamicAsyncTask().execute(url).get();
            JSONObject jsonResponse = new JSONObject(response);
